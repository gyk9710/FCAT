...
.slidebox {max-width:900px;margin:0 auto;position:relative;}
.slidebox .slidelist {position:relative;white-space:nowrap;font-size:0;}
.slidebox .slidelist .slideitem  {position:relative;display:inline-block;vertical-align:middle;background-color:#fff;width:100%;transition:all 1s;overflow:hidden}
.slidebox .slidelist .slideitem a {display:block;position:relative;}
...
.slidebox .slide-control [class*="control"] label.prev {left:-50px;background:#333 url('./resources/img/left.png') }
.slidebox .slide-control [class*="control"] label.next {right:-50px;background:#333 url('./resources/img/right.png')}
.slidebox .slide-control [class*="control"] label.prev1 {left:-50px;background:#333 url('./resources/img/left1.png') }
.slidebox .slide-control [class*="control"] label.next1 {right:-50px;background:#333 url('./resources/img/right1.png')}
...
#slide04:checked ~ .slidelist .slideitem {left:0;}
#slide05:checked ~ .slidelist .slideitem {left:-100%;}
#slide06:checked ~ .slidelist .slideitem {left:-200%;}

.slide-control [class*="control"] {display:none;}
#slide01:checked ~ .slide-control label.prev {display:none;}
...
#slide03:checked ~ .slide-control label.next {display:none;}

#slide04:checked ~ .slide-control label.prev1 {display:none;}
#slide04:checked ~ .slide-control .control01 {display:block;}
#slide05:checked ~ .slide-control .control02 {display:block;}
#slide06:checked ~ .slide-control .control03 {display:block;}
#slide06:checked ~ .slide-control label.next1 {display:none;}
					...
					<li class="slideitem">
						<div class="slideitem1">
							<a href="#" class="categoryitem">
								...
								<br>
								<span style="font-weight : bold; font-size:12px;color:black; ">싼값에 이쁜 카테고리 만들어 드립니다. 이쁘게 꾸며드릴테니 많이 찾아주세요 <br>50,000원</span>								
							</a>
						</div>
						<div class="slideitem1">
							<a href="#" class="categoryitem">
						...
						<div class="slideitem1">
							<a href="#" class="categoryitem">
								...
								<br>
								<span style="font-weight : bold; font-size:12px;color:black;">명함 이쁘게 만들어 드립니다 다른곳 보다 싸고 훨씬 이뻐요 :) <br>25,000원</span>								
							</a>
						</div>						
					</li>
					<li class="slideitem">
						<div class="slideitem1">
							<a href="#" class="categoryitem">
								...
								<br>
								<span style="font-weight : bold; font-size:12px;color:black;">하루에 1만명 방문 블로그가, 성장부터 수익화까지 알려 드립니다. <br>30,000원</span>								
							</a>
						</div>
						<div class="slideitem1">
							<a href="#" class="categoryitem">
								...
								<br>
								<span style="font-weight : bold; font-size:12px;color:black;">오토센스 누적수익 2억5천만 마케터가 오토수익방법 알려드립니다. <br>119,000원</span>								
							</a>
						</div>
						<div class="slideitem1">
							<a href="#" class="categoryitem">
								...
								<br>
								<span style="font-weight : bold; font-size:12px;color:black;">에드센스 파소나 공식으로 천만원 버는 노하우 최초공개 드립니다 <br>590,000원</span>								
							</a>
						</div>
						<div class="slideitem1">
							<a href="#" class="categoryitem">
								...
								<br>
								<span style="font-weight : bold; font-size:12px;color:black;">실제 사용중인 단타 매매법과 사용법 강의해 드립니다. <br>1,700,000원</span>								
							</a>
						</div>
					</li>
					<li class="slideitem">
						<div class="slideitem1">
							<a href="#" class="categoryitem">
								...
								<br>
								<span style="font-weight : bold; font-size:12px;color:black;">당신의 쿠팡파트너스 수익 날때까지 도와 드립니다. <br>59,000원</span>								
							</a>
						</div>
						<div class="slideitem1">
							<a href="#" class="categoryitem">
								...
								<br>
								<span style="font-weight : bold; font-size:12px;color:black;">쿠팡파트너스 월 150만원 자동화 수익 만드는 법 그대로 드립니다. <br>159,000원</span>								
							</a>
						</div>
						<div class="slideitem1">
							<a href="#" class="categoryitem">
