...
<%@include file="/WEB-INF/views/admin/adminSide.jsp" %>
    <section>
 	...
 	<form action="/adminboardWrite.do" method="post">
		...
		<div class="form-group">
			...
			<input type="text" class="titleform" placeholder="제목" name="boardTitle" required>
		</div>
	<br><br>
		<div class="form-group">
			<label for="content"></label>
			<textarea id="summernote" class="form-control" rows="5" name="boardContent" required></textarea>
		</div>
